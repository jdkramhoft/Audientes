...
public class Tab1 extends Fragment implements View.OnClickListener, View.OnLongClickListener {
    ...
    public void onResume() {
        super.onResume();
        programList = programDAO.getProgramList();
        currentProgramId = Integer.parseInt(SharedPrefUtil.readSharedSetting(Objects.requireNonNull(getContext()), "currentProgram", "1"));
        changeEqualizer(currentProgramId);
    ...
    private void updateLayout(View v) {
        ...
        SharedPrefUtil.saveSharedSetting(Objects.requireNonNull(getContext()),"currentProgram", Integer.toString(currentProgramId));
        changeEqualizer(currentProgramId);
        selectProgram(currentProgramId);
    }
